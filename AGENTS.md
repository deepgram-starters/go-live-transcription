# go-live-transcription

Go demo app for Deepgram Live Transcription.
...
```
feat(go-live-transcription): add diarization support
fix(go-live-transcription): resolve WebSocket close handling
refactor(go-live-transcription): simplify session endpoint
